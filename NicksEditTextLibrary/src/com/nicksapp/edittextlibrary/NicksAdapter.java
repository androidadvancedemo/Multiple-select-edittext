...
public class NicksAdapter extends BaseAdapter implements Filterable {

	private ArrayList<NicksItem> items;
	private ArrayList<NicksItem> suggestions;
	private Context ctx;
	private LayoutInflater inflater;
	private String TAG = this.getClass().getSimpleName();

	public NicksAdapter(Context context,ArrayList<NicksItem> items) {
		super();
		this.ctx = context;
		this.items = items;
		this.suggestions = new ArrayList<NicksItem>();
	}
	...
	@Override
	public NicksItem getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			view = inflater.inflate(R.layout.nicks_adapter, null);
			vh = new ViewHolder();
...
//			Log.i(TAG, "convertResultToString :" + resultValue);
			String str = ((NicksItem) resultValue).getTitle();
			return str;
		}
